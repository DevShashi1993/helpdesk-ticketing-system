                    ...
                    <ul className="nav flex-column">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="#">
                                <span data-feather="file"></span> My Assignments
                            </a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="#">
                                <span data-feather="shopping-cart"></span>Open tickets
                        </a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="#">
                                <span data-feather="users"></span>Bookmarks
                            </a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="#">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="#">
                                <span data-feather="layers"></span>Agenda
                            </a>
                        </li>
                    </ul>
